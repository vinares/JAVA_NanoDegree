...
public class AdminMenu {
    ...
    private static void seeAllCustomers(){
        ...
        if (!customers.isEmpty()) {
            ...
            System.out.println("There's not customers yet.");
        }
    }
    ...
    private static void seeAllRooms(){
        ...
        if (!rooms.isEmpty()) {
            ...
            System.out.println("There's no room yet.");
        }
    }
    ...
    public static void start() throws ParseException{
        ...
        while (! quit){
            ...
            } while (!i.equals("1")&&!i.equals("2")&&!i.equals("3")&&!i.equals("4")&&!i.equals("5")&&!i.equals("6")&&!quit);
        }
    }
